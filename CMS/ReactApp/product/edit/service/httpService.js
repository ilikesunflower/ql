...
export const getListProduct = ( param, callback) => {
    UserInterface.prototype.showLoading();
    http.get("/Products/Product/GetProductEdit", {params: param})
        .then(response => {
...
export const saveProductEdit =  (params, callback) => {
    UserInterface.prototype.showLoading();
    http.post("/Products/Product/SaveProductEdit", params)
        .then(response => {
            callback(response);
            UserInterface.prototype.hideLoading();
        })
