                        ...
                        <Card.Header className="row m-0 p-0 border-bottom-0 headerColor">
                            <div className="col-12">
                                ...
                                <div className="float-right pt-3  pr-3">
                                    <Button className="btn-success"  onClick={formik.formikProduct.handleSubmit}>
                                        Lưu
                                    </Button>
                                </div>
                            </div>
                                               ...
                                               <Card>
                                                   <Card.Body className="row">
                                                       ...
                                                       <Form.Group className="col-md-12 pt-3">
                                                           ...
                                                           <SelectNew2  selectKey="value" selectText="label" options={state.listProductPurpose} defaultValue={formik.formikProduct.values.productPurposeId}   formik={formik.formikProduct}  placeholder="Chọn mục đích sử dụng" name="productPurposeId"  handDelete={method.handDeletePurpose}  hand={method.handPurpose} className=" col-md-12" statusDelete={true}/>
                                                       </Form.Group>
                                                       <Form.Group className="col-md-12 pt-3">
                                                       ...
                                                       <div className="col-12  pt-3">
                                                           <div className={"row d-flex justify-content-center  " + ((state.listFile.length == 0 && state.listFileOld.length == 0)? '' : 'borderUploadMany')}>
                                                               {
                                                           ...
                                                           <Card className="">
                                                               ...
                                                               <Card.Body>
                                                                   ...
                                                                   <div className="row  d-flex justify-content-center">
                                                                       ...
                                                                       {state.listProperProduct.length > 0 && state.listProperties.length != 0  && (
                                                                           <div className="col-12 pb-3"  >
                                                                               <div className="row">
                                                                                               ...
                                                                                               {state.listProperProduct.map((item, i)=> {
                                                                                                   return (
                                                                                                       <tr key={i}>
                                                                                                           ...
                                                                                                           <td>
                                                                                                               <NumberFormat isAllowed={withValueLimit}  className="form-control form-control-xl  " thousandSeparator={'.'} decimalSeparator={','} name="price" autoComplete="off" {...props}
...
const ModalPurpose = props => {
    const {handPurpose, formik, show} = props;
    return(
        <Modal  show={show}  onHide={handPurpose} animation={false}>
