...
import {getChartArea} from "./httpService"
    ...
    return (
        <Row>
            <Col md={12}>
                <Card>
                        <Card.Header >
                            <h5 className="text-color-default font-weight-bold m-b-0 text-uppercase">Sản lượng bán ra theo khu vực</h5>
                        </Card.Header>
                        <Card.Body>
                            <Form className="row">
