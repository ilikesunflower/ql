...
function MainController(props) {
    ...
    let [fromDate, setFromDate] = useState(moment().format("DD/MM/YYYY"));
    ...
    return (
        <Row>
            <Col md={12}>
                <Card>
                    <Card.Header>
                        <h5 className="text-color-default font-weight-bold m-b-0 text-uppercase">Báo cáo hoạt động khách hàng</h5>
                    </Card.Header>
                    <Card.Body>
                        <Form className="row">
