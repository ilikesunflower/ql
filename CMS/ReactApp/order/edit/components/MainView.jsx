...
function MainApp(props) {
    ...
    console.log(state.customerPoint , state.customerPointOld)
    return (
        <Row>
            {(state.showModelDetailProduct) && <MainView  setCheckDeleteProduct={method.setCheckDeleteProduct} formik={formik}  showModelDetailProduct={state.showModelDetailProduct} setShowModelDetailProduct={method.setShowModelDetailProduct} setListProductSelect={method.setListProductSelect} listProductSelect={state.listProductSelect} setListProductPropertiesSelect={method.setListProductSelect}  id={state.productSelect} handShowDetailProduct={method.handShowDetailProduct}/>}
                            ...
                            <Card.Body  className="row">
                                <Form.Group className="col-md-12 pt-3">
                                    ...
                                    <div className="input-group m-0 row">
                                        <Select2ComponentNew defaultValue={state.productSelect} onChange={method.handleChangeSelect} name="productSelect" className=" rounded-0 col-md-10 col-sm-9 pr-0" placeholder="Chọn sản phẩm" options={state.listProduct} selectKey={"id"} selectText={"name"} />
                                    ...
                                    <>
                                        <div className="table-responsive  col-12 mt-3 pl-3">
                                            <table className="table table-bordered ">
                                                ...
                                                <tr>
                                                    <th>Sản phẩm</th>
                                                    <th className="text-center d-none d-xl-table-cell">Đơn giá (đồng)
                                                    </th>
                                                    <th className="text-center d-none d-xl-table-cell">Số lượng</th>
                                                    <th className="text-center d-none d-xl-table-cell">Thành tiền
                                                        (đồng)
                                                    </th>
                                                                ...
                                                                <td className="text-center  align-middle">
                                                                    <div className="btn-group ">
                                                                        <button type="button" className="btn "
                                                                                onClick={(e) => method.clickQuantityBuy(1, i)}>
                                                                            <i className="fa-solid fa-minus"></i>
                                                                        </button>
                                                                        <NumberFormat
                                                                            className="form-control form-control-xl inputQuantity   "
                                                                            thousandSeparator={'.'}
                                                                            decimalSeparator={','} name="price"
                                                                            autoComplete="off"
                                                                            value={!Number.isNaN(Number.parseInt(item.quantityBy)) ? Number.parseInt(item.quantityBy) : 0}
                                                                            onValueChange={(e) => method.changeQuantityBuy(e, i)}/>
                                                                        <button type="button" className="btn "
                                                                                onClick={(e) => method.clickQuantityBuy(2, i)}>
                                                                            <i className="fa-solid fa-plus"></i>
                                                                        </button>
                                                                    </div>
                                                                    <br/>
                                                                    <span
                                                                        className="textCss">(Còn {formatNumber(item.quantityWH)} sản phẩm)</span>
                                                                </td>
                                                                <td className="text-center  align-middle">
                                                                    {formatNumber(item.quantityBy * item.price)}
                                                                </td>
                                                                <td className="text-center  align-middle">
                                                                    <button type="button" className="buttonNoColor"
                                                                            onClick={() => method.deleteProductSelect(i)}>
                                                                        <i className="fa-solid fa-trash text-hover-red"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                        )
                                                    ...
                                                    <div className="row mt-3">
                                                        <div className="col-md-10">
                                                            <div className="styleLastTable justify-content-end">
                                                                ...
                                                                <span
                                                                    className="txt-helper">( Bạn đang có {formatNumber(state.customerPoint + state.customerPointOld)} điểm)</span>
                                                                <div className="btn-group ">
                                                                    <button type="button" className="btn "
                                                                            onClick={method.applyPointDecrease}>
                                                                        <i className="fa-solid fa-minus"></i>
                                                                    </button>
                                                                    <NumberFormat
                                                                        className="form-control form-control-xl inputQuantity  "
                                                                        ...
                                                                        value={!Number.isNaN(Number.parseInt(formik.values.point)) ? Number.parseInt(formik.values.point) : 0}
                                                                        onValueChange={method.applyPoint}/>
                                                                    <button type="button" className="btn "
                                                                            onClick={method.applyPointIncrease}>
                                                                        <i className="fa-solid fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="col-md-2">
                                                            <div className="d-flex justify-content-end">
                                                                <strong>-{formatNumber(formik.values.point * isPoi)}
                                                                    <u>đ</u></strong>
                                                            </div>
                                                ...
                                                <div className="col-12">
                                                    <div className="row mt-3">
                                                        <div className="col-md-10">
                                                            <div className="styleLastTable justify-content-end">
                                                                <span
                                                                    className="text-right">Coupon {!state.couponCode ? '' : `(${state.couponCode})`}</span>
                                                                <span className="txt-helper">( Sử dụng coupon để được giá tốt nhất )</span>
                                                                <div className="d-flex justify-content-end">
                                                                    <div className="input-group input-group-sm w-193px">
                                                                        <input type="text" disabled={true} value={formik.values.couponCode}
                                                                               onChange={ev => method.setDiscountCode(ev.target.value)}
                                                                               className="form-control form-control-sm"
                                                                               placeholder="Nhập mã"/>
                                                                        <span className="input-group-append">
                                                                <button type="button"
                                                                        className="btn btn-danger btn-flat"
                                                                        onClick={method.handShowModalCoupon}><i
                                                        ...
                                                        <div className="col-md-2">
                                                            <div className="d-flex justify-content-end">
                                                                <strong>-{formatNumber(state.couponDiscount)}
                                                                    <u>đ</u></strong>
                                                            </div>
                                                ...
                                                <div className="col-12">
                                                    <div className="row mt-3">
                                                        ...
                                                        <div className="col-md-2">
                                                            <div className="d-flex justify-content-end">
                                                                <strong
                                                                    className="total-price">{formatNumber(state.totalPrice)}
                                                                    <u>đ</u></strong>
                                                            </div>
