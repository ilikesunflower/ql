    ...
    public SendShip? SendShip(CMS_EF.Models.Orders.Orders orders)
    {
        if (orders.ShipPartner == 1)
        {
            ...
            CreatedOrder c = new CreatedOrder()
            {
                ...
                ToAddress = !string.IsNullOrEmpty(orders.OrderAddress.Address) ? orders.OrderAddress.Address : $"{orders.OrderAddress?.Province?.Name} - {orders.OrderAddress?.District?.Name} - {orders.OrderAddress?.Commune?.Name}",
        ...
        if (orders.ShipPartner == 2)
        {
            ...
            CMS_Ship.VnPost.Models.CreatedOrder v = new CMS_Ship.VnPost.Models.CreatedOrder()
            {
                ...
                ReceiverAddress = !string.IsNullOrEmpty(orders.OrderAddress.Address) ? orders.OrderAddress.Address : $"{orders.OrderAddress?.Province?.Name} - {orders.OrderAddress?.District?.Name} - {orders.OrderAddress?.Commune?.Name}",
