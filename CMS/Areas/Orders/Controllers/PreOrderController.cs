    ...
    public IActionResult CreateOrder([FromForm] CreateOrderViewModel model)
    {
        if (ModelState.IsValid)
        {
            ...
            var orders = new CMS_EF.Models.Orders.Orders
            {
                ...
                Point = model.Point,
                Note = "",
                BillCompanyName =  preOrder.Customer.TypeGroup == customerType ? PrudentialBillInfo.BillCompanyName : preOrder.BillCompanyName,
                BillTaxCode = preOrder.Customer.TypeGroup == customerType ? PrudentialBillInfo.BillTaxCode : preOrder.BillTaxCode,
                BillAddress = preOrder.Customer.TypeGroup == customerType ? PrudentialBillInfo.BillAddress : preOrder.BillAddress,
                BillEmail = preOrder.Customer.TypeGroup == customerType ? PrudentialBillInfo.BillEmail : preOrder.BillEmail,
